...
function loadingAnimation() {
  // var cursr = document.querySelector("#crsr");
...
function cursorAnimation() {
  ...
  Shery.makeMagnet("#nav-part2 h4,#svg1");
...
function sheryAnimation() {
  Shery.imageEffect(".image-div", {
    ...
    config: {
      ...
      aspect: { value: 0.7272695249844764 },
...
function headingImageDiv() {
  const container = document.querySelectorAll(".h2animation");

  container.forEach(function (con) {
    var h21 = con.querySelector(".h11");
    var h22 = con.querySelector(".h22");
